<?php
  ...
  function ConsultarProducto($id_prod)
  {
    ...
    include("con_db.php");
    include("regresar_reg_mi.php");
    $sentencia="SELECT * FROM microfonos WHERE Id='".$id_prod."' ";
  ...
  <div id="contenido">
    ...
    <h1 class="text-center">Modificar producto</h1>
  	...
  	<div id="contenido">
  		...
  		<br>
      <form action="modif_prod2_mi.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
